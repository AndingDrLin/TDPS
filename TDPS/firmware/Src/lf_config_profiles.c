...
void LF_Config_ApplyDebugProfile(void)
{
    ...
    g_lf_config.lead_advance_ticks = 14U;
    g_lf_config.lead_advance_speed = 60;
    g_lf_config.lead_turn_hold_ticks = 7U;
    g_lf_config.lead_turn_speed = 50;
    g_lf_config.lead_turn_delta = 80;
    g_lf_config.lead_entry_memory_ticks = 32U;
