...
void LF_Config_ApplyTrackProfile(void)
{
    ...
    g_lf_config.ki = 0.0f;
    g_lf_config.kd = 0.45f;
    g_lf_config.base_speed = 300;
    g_lf_config.adaptive_slow_speed = 220;
    g_lf_config.sharp_turn_speed = 150;
    ...
    g_lf_config.straight_boost_speed = 360;
    g_lf_config.curve_prepare_speed = 180;
    g_lf_config.derivative_filter_alpha = 0.80f;
