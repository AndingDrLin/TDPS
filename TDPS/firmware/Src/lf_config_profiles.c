...
void LF_Config_ApplyDebugProfile(void)
{
    ...
    g_lf_config.kp = 0.10f;
    g_lf_config.ki = 0.0f;
    g_lf_config.kd = 0.18f;
    g_lf_config.base_speed = 150;
    g_lf_config.adaptive_slow_speed = 60;
    g_lf_config.sharp_turn_speed = 35;
    g_lf_config.max_correction = 180;
    g_lf_config.straight_boost_enable = false;
    g_lf_config.curve_prepare_enable = false;
    g_lf_config.line_stability_enable = false;
    g_lf_config.stable_direction_enable = false;
    ...
    g_lf_config.lead_advance_ticks = 18U;
    g_lf_config.lead_advance_speed = 65;
    g_lf_config.lead_turn_hold_ticks = 16U;
    g_lf_config.lead_turn_speed = 55;
    g_lf_config.lead_turn_delta = 115;
    g_lf_config.lead_entry_memory_ticks = 40U;
    ...
    g_lf_config.max_output_delta_per_tick = 20;
