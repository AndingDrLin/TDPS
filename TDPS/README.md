...
- 巡线输入固定为 8 路，支持 ADC 模拟量、8-LP 数字 GPIO 和 8-LP UART 协议模式；当前实车 track profile 使用 UART 模式和极性翻转。
- `main.c` 默认调用 `LF_Config_ApplyTrackProfile()`，启用直道高速、弯前减速、抗干扰、可信方向恢复和岔路识别。
